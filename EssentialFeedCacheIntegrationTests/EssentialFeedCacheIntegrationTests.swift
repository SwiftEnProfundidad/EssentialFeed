...
class EssentialFeedCacheIntegrationTests: XCTestCase {
    ...
    // Caso en el que el método `load` debe entregar elementos guardados en instancias separadas,
    // demostrando que almacenamos cosas en disco, con lo que otra instancia puede obtener esos datos del disco
