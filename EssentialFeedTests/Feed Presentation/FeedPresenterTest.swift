...
final class FeedPresenter {
    ...
    private var feedLoadError: String {
        return NSLocalizedString("FEED_VIEW_CONNECTION_ERROR",
                                 ...
                                 comment: "Error message displayed when we can't load the image feeed from the server")
    }
...
class FeedPresenterTest: XCTestCase {
    ...
    private class ViewSpy: FeedView, FeedLoadingView, FeedErrorView {
        ...
        // en el array `messages` al hacerlo con un conjunto, no importa
        // el orden y no romperá nuestros test.
