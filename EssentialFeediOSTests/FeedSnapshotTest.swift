...
extension UIViewController {
    // Ahora el renderizado ya no ocurre en el `ViewController` si no en la `window`
...
// Utilizamos esta `Window` solo durante los test para sobreescribir la configuración de la `view`
